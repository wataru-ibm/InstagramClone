...
class HomeViewController: UIViewController {
    ...
    private let collectionView = HomeCollectionView(frame: .zero)
    ...
    private func setupUI() {
        dataSource = UICollectionViewDiffableDataSource<Section, Post>(collectionView: collectionView){collectionView, indexPath, post in
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: HomePostCell.reuseIdentifier, for: indexPath) as? HomePostCell else {
